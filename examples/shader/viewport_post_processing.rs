...
use bevy::{
    core_pipeline::{
        ...
        viewport_vertex_shader::{viewport_shader_vertex_state, ViewportUniform},
    },
    ecs::query::QueryItem,
    prelude::*,
    render::{
...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        let vertex_bind_group = render_context.render_device().create_bind_group(
            "post_process_vertex_bind_group",
            &post_process_pipeline.vertex_layout,
            // It's important for this to match the BindGroupLayout defined in the PostProcessPipeline
            &BindGroupEntries::sequential((
                &UniformBuffer::from(ViewportUniform { viewport: Vec4::new(0.0, 0.0, 1.0, 1.0) }),
            )),
        );
        ...
        render_pass.set_bind_group(1, &vertex_bind_group, &[]);
...
impl FromWorld for PostProcessPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let vertex_layout = render_device.create_bind_group_layout(
            "post_process_bind_group_vertex_layout",
            &BindGroupLayoutEntries::sequential(

                ShaderStages::VERTEX,
                (
                    // `dof_params`
                    uniform_buffer::<ViewportUniform>(true),
                ),
            ),
        );
        ...
        let pipeline_id = world
            ...
            .queue_render_pipeline(RenderPipelineDescriptor {
                ...
                layout: vec![layout.clone(), vertex_layout.clone()],
                // This will setup a two triangles for the viewport for the vertex state
                vertex: viewport_shader_vertex_state(),
